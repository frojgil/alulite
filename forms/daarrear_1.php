            ...
            <form role="form" method="POST" id="desigForm" name="desigForm">
                <div class="box-body">
                    <div class="form-group col-xs-3">
                        ...
                        <input type="text" class="form-control input-sm" required="required" id="olddaratetxt" name="olddaratetxt" placeholder="Old DA Rate ">
                    </div>
                    <div class="form-group col-xs-3">
                        <label for="newdarate">New DA Rate (%)</label>
                        <input type="text" class="form-control input-sm" required="required" id="newdaratetxt" name="newdaratetxt" placeholder="New DA Rate (%)">
                    </div>
                ...
                <div class="box-footer">
                    ...
                    <input type="submit" class="btn btn-primary" id="btnSubmit" value="Generate All Employee" />
