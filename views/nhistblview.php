...
$output = array();
$query = "SELECT e.name as name,n.nhisamt as nhisamt,n.emp_no as emp_no from nhis_adv as n inner join emp_master as e on e.emp_no = n.emp_no;";
$result = mysql_query($query) or die(mysql_error());
while ($person = mysql_fetch_array($result)) {
    $output[] = array('emp_no' => $person['emp_no'], 'name' => $person['name'], 'nhisamt' => $person['nhisamt'],
